...
<![endif]-->
		...
		<script src="admin/js/admin.default.js"></script>
...
</script><script src="/assets/f2b97537/jquery.js"></script>
<script src="/assets/cd9fea75/yii.js"></script>
<script src="/assets/cd9fea75/yii.gridView.js"></script>
<script src="/assets/cb2d7fd4/js/bootstrap.js"></script>
<script type="text/javascript">jQuery(document).ready(function () {
jQuery('#w0').yiiGridView({"filterUrl":"\/index.php?r=admin%2Fadmin%2Findex","filterSelector":"#w0-filters input, #w0-filters select"});
});</script>
	<?php $this->endBody() ?>
</body>
</html>
